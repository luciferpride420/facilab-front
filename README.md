# FaciLab Frontend Platform

## Project info

This is a native cross-platform mobile app for the FaciLab medical laboratory platform.
...
You can work locally using your preferred code editor. We recommend Cursor or VS Code.
...
- Visit [Expo's documentation](https://docs.expo.dev/) for platform-specific questions

## About FaciLab

FaciLab is a comprehensive medical laboratory platform built with React Native and Expo - the same technology stack used by Discord, Shopify, Coinbase, Instagram, and nearly 30% of the top 100 apps on the App Store.
